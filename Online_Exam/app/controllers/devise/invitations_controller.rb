class Devise::InvitationsController < DeviseController
  ...
  def new
   ...
   def configure_permitted_parameters
    devise_parameter_sanitizer.permit(:accept_invitation, keys: [:full_name, :image])
    devise_parameter_sanitizer.permit(:invite, keys: [:email, :role , :full_name ,:image])
  ...
  def create
    ...
    if resource_invited
       CustomDeviseMailer.invitation_instructions(resource, resource.invitation_token).deliver_now
  ...
  def edit
    ...
    resource.full_name = params[:full_name]
  # resource.role = resource.role_from_invitation(params[:user][:role])
    render :edit
  end
